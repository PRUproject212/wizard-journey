...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        PlayerHealth.PlayerMoveToPointStart += MoveToPointStart;
    }

    private void OnDestroy() => PlayerHealth.PlayerMoveToPointStart -= MoveToPointStart;
        
    public void MoveToPointStart() => transform.position = pointStart;
